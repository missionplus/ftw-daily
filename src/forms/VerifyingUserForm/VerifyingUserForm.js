...
import css from './VerifyingUserForm.module.css';
...
const VerifyingUserFormComponent = props => {
...
VerifyingUserFormComponent.defaultProps = {
  className: null,
  currentUser: null,
...
VerifyingUserFormComponent.propTypes = {
...
const VerifyingUserForm = compose(injectIntl)(VerifyingUserFormComponent);

export default VerifyingUserForm;
